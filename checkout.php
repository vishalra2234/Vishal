...
<section class="max-w-2xl mx-auto px-4 py-10">
  ...
  <div class="bg-white rounded-xl p-6 shadow-sm space-y-4">
    <input id="courseId" class="w-full border p-2 rounded" value="<?= (int)$courseId ?>" placeholder="Course ID" />
    ...
    <p class="text-xs text-gray-500">This demo simulates gateway confirmation; integrate Razorpay signature verification for production.</p>
